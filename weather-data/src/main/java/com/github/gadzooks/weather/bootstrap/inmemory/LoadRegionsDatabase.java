...
//    @Setter FIXME use application.yml
    private String regionsFilePath = "src/main/resources/regions.yml"; //being set from application.yml
//    @Setter FIXME use application.yml
    private String locationsFilePath = "src/main/resources/locations.yml"; //being set from application.yml
